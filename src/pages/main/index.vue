...
const { modelSize, handleLoad, handleDestroy, handleResize, handleKeyChange } =
  useModel();
...
watch(() => generalStore.taskbarVisibility, setTaskbarVisibility, {
  immediate: true,
});
...
async function handleContextmenu(event: MouseEvent) {
  ...
  const sharedItems = await getSharedMenu();
